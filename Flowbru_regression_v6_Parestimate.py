...
inputfile1 = r'd:\VUB\Python codes\FCS_input_files\9modeledStns.csv'


##path to the csv file with station information
path_sw = r'd:\VUB\Python codes\FCS_input_files\wastewatercollectorslocation_new.csv'
...
path_rain = r'd:\VUB\Python codes\FCS_input_files\Rainfall_guageing_stations.csv'
...
outfolder=r'D:\VUB\Modelling_result'
